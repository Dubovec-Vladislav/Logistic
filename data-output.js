function dataOutput(cars, points, percent) {
  ...
  cars.forEach((item) => {
    ...
    htmlString += `<div class="cars__list-point point"><span>Время работы на маршруте:</span> ${(WORK_TIME - item['ОставшеесяВремяРаботы']).toFixed(2)} час(-а)</div>`;
